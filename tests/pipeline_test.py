...
def process(
    save_pipeline_name=DEFAULT_PIPELINE,
    ...
    for extractor in extractors:
        for isolator in isolators:
            ...
            pipeline = NewPipeline(
                save_pipeline_name, abs_trainer_names, dyn_trainer_names, extractor=extractor, isolator=isolator, target_energy_sources=target_energy_sources, valid_feature_groups=valid_feature_groups
            )
