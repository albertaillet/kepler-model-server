            ...
            for node_type in node_types:
                ...
                for component in energy_components:
                    ...
                    if node_type_key not in profile[component]:
                        profile[component][node_type_key] = {min_watt_key: min_watt, max_watt_key: max_watt}
                    else:
...
class Profile:
    ...
    def print_profile(self):
        print(
            "Profile (node type={}): \n Available energy components: {}\n Available minmax scalers: {}\n Available standard scalers: {}".format(
                self.node_type, ["{}/{}".format(key, list(self.profile[key].keys())) for key in self.profile.keys()], self.minmax_scaler.keys(), self.standard_scaler.keys()
            )
        )
